...
-   We can also find that the Coordinate Reference System (CRS) `crsSupported` is [`r sf::st_crs("EPSG:31370")$Name`](https://epsg.io/31370). Always good to know.
...
Once a web service layer is succesfully loaded in QGIS, one can inspect URLs and metadata in the layer properties.
The QGIS dialog to add a webservice layer is also helpful in exploring available layers of a web service. 
