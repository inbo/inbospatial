...
vignette: >
  %\VignetteIndexEntry{Dissecting a WCS Query: DHMV Case Study.}
...
```{r fig-qgis, echo=FALSE, out.width='90%'}
...
unpack_mht <- function(path) {
  ...
  # We search for \n-- to safely find the closing boundary and cut the file there.
