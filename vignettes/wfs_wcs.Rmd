...
```{r}
system.time({
  provinces2 <- read_sf(paste0("OAPIF:", ogc_vrbg),
                        layer = "Refprv"
  )
})
...
To our knowlegde, an `OGC APi features` service is not available for this vector data source.
...
As a proof of concept, we can directly query bwk parameters at a specific location.
