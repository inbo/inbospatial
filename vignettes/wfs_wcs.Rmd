...
For a more in-depth explanation about WFS services, we refer to [the INBO tutorial about WFS](https://tutorials.inbo.be/tutorials/tutorials/spatial_wfs_services/){target="_BLANK"}.
