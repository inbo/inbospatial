...
Another example of a WFS API is the Belgian Royal Metheorological Institute (KMI, "Koninklijk Meteorologisch Instituut van België").
...
For example, features can be selected by intersection with another geo-object.
